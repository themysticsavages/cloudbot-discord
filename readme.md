...
<p align="center">
  ...
  <a href="https://github.com/themysticsavages/cloudbot-discord/etc/blob/main/setup.md">
</p>
...
[Read setup.md](https://github.com/themysticsavages/cloudbot-discord/blob/main/setup.md) if you want to self-host the bot.
